...
content <- tribble(
  ...
  # datasets
  ## evs2017
  paste("[evs2017](https://cgmoreh.github.io/HSS8005-24/data/evs2017.rds)"), ".Rds",
  ...
  ## Ejrnæs
  paste("[Ejrnaes21](https://cgmoreh.github.io/HSS8005/data/Ejrnaes21.dta)"), ".dta", "Replication data for @EjrnaesJensen2021GoYourOwnWayPathways, based on data from the European Social Survey Round 8. The original dataset provided by the authors is called ***G&O_Final.tab*** and the original analysis was performed in Stata.",
      paste("[Data source](https://dataverse.harvard.edu/dataset.xhtml?persistentId=doi:10.7910/DVN/VAFIIO)", "<br>", "[Open access article](https://research.cbs.dk/en/publications/go-your-own-way-the-pathways-to-exiting-the-european-union)", "<br>", "[Supplementary materials](https://static.cambridge.org/content/id/urn:cambridge.org:id:article:S0017257X20000378/resource/name/S0017257X20000378sup001.docx)"),
  ## workout
  paste("[workout](https://cgmoreh.github.io/HSS8005/data/workout.Rds)"), ".Rds", "Example dataset from @MehmetogluMittner2021AppliedStatisticsUsingGuideSocial; a combined version of the original `workout2` and `workout3` datasets included in the {astatur} package",
